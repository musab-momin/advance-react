 ...
 * the update of state or lower its priority. consider a situation where bunch of hooks are in your component
 ...
 * of the state update, in other words it will going to update the state when all the state updates has been
 * done.
 */
